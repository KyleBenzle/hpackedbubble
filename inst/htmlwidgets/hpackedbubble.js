  ...
  factory: function(el, width, height) {
    ...
    return {
      ...
      renderValue: function(x) {
                if (x.theme == "darkgreen") { (function(a) {
                    ...
                    if (x.theme == "darkblue") { (function(a) {
                            "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define(function() {
                                return a
                            }) : a("undefined" !== typeof Highcharts ? Highcharts: void 0)
                        })(function(a) {
                        ...
                        if (x.theme == "avocado") { (function(a) {
                            ...
                            if (x.theme == "darkunica") { (function(a) {
                                    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define(function() {
                                        return a
                                    }) : a("undefined" !== typeof Highcharts ? Highcharts: void 0)
                                })(function(a) {
                                ...
                                if (x.theme == "gray") { (function(a) {
                                    ...
                                    if (x.theme == "gridlight") { (function(a) {
                                            "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define(function() {
                                                return a
                                            }) : a("undefined" !== typeof Highcharts ? Highcharts: void 0)
                                        })(function(a) {
                                        ...
                                        if (x.theme == "grid") { (function(a) {
                                            ...
                                            if (x.theme == "sandsignika") { (function(a) {
                                                    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define(function() {
                                                        return a
                                                    }) : a("undefined" !== typeof Highcharts ? Highcharts: void 0)
        ...
        // TODO: code to render the widget, e.g.
                ...
                var count = 1;
                var index = 0;
                for (var key in uniquecat){
                  var listData = [];
                  if (count == 1) {
                    for (var j = 0; j < uniquecat[key]; j++) {
                      listData.push({name: x.name[j], value: x.value[j]});
                    }
                  }else{
                    for (var j = index; j < index + uniquecat[key]; j++) {
                      listData.push({name: x.name[j], value: x.value[j]});
                    }
                  }
                  index = index + uniquecat[key];
                  listSeries.push({name: key, data: listData});
                  count++;
                };
                Highcharts.chart(id, {
                  chart: {
                  ...
                  tooltip: {
                      useHTML: true,
                      pointFormat: x.pointFormat
                  },
                  plotOptions: {
                      packedbubble: {
                          minSize: x.packedbubbleMinSize,
                          maxSize: x.packedbubbleMaxSize,
                          zMin: x.packedbubbleZMin,
                          zMax: x.packedbubbleZMax,
                          layoutAlgorithm: {
                              gravitationalConstant: x.gravitational,
                              splitSeries: 1==x.split,
                              seriesInteraction: 1==x.seriesInteraction,
                              dragBetweenSeries: 1==x.dragBetweenSeries,
                              parentNodeLimit: 1==x.parentNodeLimit
                          },
                          dataLabels: {
                              enabled: 1==x.dataLabels,
                              format: x.dataLabelsformat,
                              filter: {
                                  property: 'y',
                                  operator: '>',
                                  value: x.dataLabelsFilter
                              },
                              style: {
